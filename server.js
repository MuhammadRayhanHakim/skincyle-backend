...
const checkoutRoutes = require("./src/routes/checkoutRoutes");
const orderRoutes = require("./src/routes/orderRoutes");
const midtransRoutes = require("./src/routes/midtransRoutes"); // 🚀 IMPOR: Menghubungkan rute baru callback Midtrans
...
app.use("/api/keranjang", keranjangRoutes);
app.use("/api/produk", produkRoutes);
app.use("/api/midtrans", midtransRoutes); // 🚀 PASANG DI SINI: Akses publik '/api/midtrans/callback' kebal dari authMiddleware
app.use("/api/checkout", checkoutRoutes);
app.use("/api", orderRoutes);
